...
class M_login extends CI_Model {
	...
	public function login($data) {
		$sql = 'SELECT id, email FROM profile WHERE email = ? AND password = ?';
	...
	public function register($data) {
		$sql = 'INSERT INTO `profile` (email, password) VALUES (?,?)';
	...
	public function cek_email($email) {
		$sql = 'SELECT email FROM profile WHERE email = ? limit 1';
