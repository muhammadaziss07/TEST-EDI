...
class M_education extends CI_Model {
	...
	public function insert($data) {
		$sql = 'INSERT INTO pendidikan (id, jenjang, nama, jurusan, tahun, ipk) VALUES (?,?,?,?,?,?)';

		$this->db->query($sql, array($data['id'], $data['jenjang'], $data['nama'], $data['jurusan'], $data['tahun'], $data['ipk']));
	}
