          		...
          		<div class="row">
                    ...
                    <!-- <center>
                      <div class="form-group">
                        <div style="border: 1px solid black; width: 200px; height: 235px; padding: 10px; margin-bottom: 10px;">
                          <?php
                              if ($profiles[0]['picture'] != '')
                                  $src = 'http://localhost/user/' . $profiles[0]['picture'];
                              else
                                  $src = '';
                          ?>
                          <img src="<?= $src; ?>" alt="Your profile image goes here" id="profile_img" width="100%" height="100%">
                        </div>
                        <div class="info-user ml-3">
                          <span class="username" id="chg_pic_btn" style="cursor: pointer;"> Change
                          </span>
                  	...
                  	<div class="form-group">
                    	<label>NAMA</label>
                    	<input type="text" name="nama" class="form-control" required autocomplete="off" value="<?= $profiles[0]['nama']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>No. KTP</label>
                    	<input type="text" name="ktp" class="form-control" required autocomplete="off" value="<?= $profiles[0]['ktp']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>TEMPAT, TANGGAL LAHIR</label>
                    	<input type="text" name="lahir" class="form-control" required autocomplete="off" value="<?= $profiles[0]['lahir']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>JENIS KELAMIN</label>
                    	<input type="text" name="kelamin" class="form-control" required autocomplete="off" value="<?= $profiles[0]['kelamin'] ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>AGAMA</label>
                  	...
                  	<div class="form-group">
                    	...
                    	<input type="text" name="alamat_ktp" class="form-control" required autocomplete="off" value="<?= $profiles[0]['alamat_ktp']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>ALAMAT TINGGAL</label>
                    	<input type="text" name="alamat_tinggal" class="form-control" required autocomplete="off" value="<?= $profiles[0]['alamat_tinggal']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>EMAIL</label>
                    	<input type="text" name="email" class="form-control" required autocomplete="off" value="<?= $profiles[0]['email']; ?>">
                  	</div>
                  	<div class="form-group">
                    	<label>NO. TELP</label>
