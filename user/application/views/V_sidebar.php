    ...
    <header class="app-header"><a class="app-header__logo" href="#">Test Online~EDI</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown">
          ...
          <img class="app-sidebar__user-avatar" src="http://localhost/koolab/freelancer/assets/uploads/profile/file_1607024751.jpg" alt="User Image" style="width: 30px; height: 27px;">
        </a>
